    ...
    try {
      ...
      const vehicleDetails = await axios({
          ...
          params:{
              ...
              params: '{"reportResourceId":22542222,"reportTemplateId":1,"reportTemplate":null,"reportObjectId":"27732669","reportObjectSecId":0,"interval":{"from":'+reportFrom+',"to":'+report+',"flags":0}}',
              sid: token
          }
      });
